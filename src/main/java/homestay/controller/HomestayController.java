...
public class HomestayController {
	...
	public BookingData updateBooking(@PathVariable Long bookingId, @RequestBody BookingData bookingData) {
		...
		return homestayService.updateBooking(bookingData);
	}
	...
	public BookingData retrieveBookingById(
	...
	@ResponseStatus(code = HttpStatus.CREATED)
	public HostFamilyData createHostFamily(
		@RequestBody HostFamilyData hostFamilyData) {
	...
	public HostFamilyData updateHostFamily(@PathVariable Long hostId, @RequestBody HostFamilyData hostFamilyData) {
		...
		return homestayService.updateHostFamily(hostFamilyData);
	}
	...
	public StudentData retrieveStudentById(
	...
	public PreferenceData retrievePreferenceById(
